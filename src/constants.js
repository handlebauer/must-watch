...
export const DISCORD_WEBHOOK_MAP = {
  primary: process.env.DISCORD_WEBHOOK_URL_LOG,
  secondary: process.env.DISCORD_WEBHOOK_URL_RUNNER_UP_LOG,
  internal: process.env.DISCORD_WEBHOOK_URL_INTERNAL_LOG,
}
